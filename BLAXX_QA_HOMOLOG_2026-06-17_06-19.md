...
**Data:** 17/06/2026 06:19:49  
**Ambiente:** Homologação isolada (SQLite em memória)  
**Resultado:** 129/130 PASS | 1 FAIL  
**Status:** 🔴 BLOQUEADO — corrigir blockers  
...
| C1: ID único gerado | ✅ PASS | id=a3c20dba905f407dbd8c482aed0ae5cd |
...
| C4: Delta → Epsilon 20.000 pts → BLOQUEADO saldo insuf. | 🔴 FAIL | http=201 saldo_delta=0 |
| C4: Saldo de Delta NÃO alterado | ✅ PASS | saldo=0 |
...
| C10: Segunda tx com mesmo key → mesmo ID (dedup) | ✅ PASS | id1=d0d10148fab74414bfa316b387ab84e5 id2=d0d10148fab74414bfa316b387ab84e5 |
...
| AuditLog registra eventos (≥1 entrada) | ✅ PASS | entradas=40 |
...
| # | Descrição | Severidade | Seção |
|---|---|---|---|
| 1 | C4: Delta → Epsilon 20.000 pts → BLOQUEADO saldo insuf. | 🔴 Crítica | Transferência |
